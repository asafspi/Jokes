...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokes-151210.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.user.myapplication.backend.myApi.model.Joke> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.user.myapplication.backend.myApi.model.Joke.class);
    }
